...
urlpatterns = [
	...
	path('examen_sangre/<pk>/delete/',ExamenSangreDelete.as_view(), name='examen_sangre_delete'),
	...
	path('examen_orina/<pk>/delete/',ExamenOrinaDelete.as_view(), name='examen_orina_delete'),
